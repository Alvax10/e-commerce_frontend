...
export function Footer({ className }) {
    ...
    return <div className={className}>
        ...
        { userDataSaved ? <div className="general-div">
            <div className="mobile-footer">
                ...
                <div className="image-container">
                    <p className="apx" style={{ color: "#FEFEFE" , fontSize: 16, marginTop: 65 }} > ©2022 apx </p>
                    <ApxMobileLogo />
                </div>
            </div>
            ...
            <div className="desktop-footer">
                ...
                <div className="image-container">
                    <ApxDesktopLogo />
                    <p className="apx" style={{ color: "#FEFEFE" , fontSize: 16 }} > ©2022 apx </p>
                </div>
            </div>
        </div>
