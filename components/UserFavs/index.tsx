...
export function UserFavComponent({ className }) {
    ...
    return cart ? <div className={className}>
    ...
    <div className={className}>
        ...
        <div style={{ display: "flex", alignItems: "center", flexDirection: "column" }}>
            ...
            <BodyStyle> Quieres tener favoritos? Añade productos! </BodyStyle>
            <div className="button-container" onClick={goToProducts}>
                <SecondaryButton width={250 + "px"} height={50 + "px"}> Agergar Productos </SecondaryButton>
            </div>
        </div>
    </div>
}